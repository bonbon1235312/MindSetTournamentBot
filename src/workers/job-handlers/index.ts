 ...
 * GROUP_CONFIRMATION_DEADLINE, RESULT_FIRST_REMINDER, RESULT_STAFF_ALERT,
 * PRIZE_DETAILS_DEADLINE, MIDNIGHT_CLEANUP) will fail with "No handler
 * registered" if ever enqueued — see PLAN.md's known gaps.
 */
